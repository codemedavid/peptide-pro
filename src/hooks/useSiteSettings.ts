  ...
  const fetchSiteSettings = async () => {
    try {
      ...
      const settings: SiteSettings = {
        site_name: settingsData.find(s => s.id === 'site_name')?.value || 'Peptide Pro',
        ...
        hero_description: settingsData.find(s => s.id === 'hero_description')?.value || 'Peptide Pro is your destination for high-quality peptide solutions rooted in modern science, transparency, and patient-focused innovation.',
