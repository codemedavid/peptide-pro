        ...
        <div className="space-y-6 animate-fadeIn transition-all duration-300">
            ...
            <div className="space-y-6 text-gray-700 leading-relaxed overflow-y-auto max-h-[60vh] pr-2">
                <section>
                    ...
                    <p>By accessing and using Peptide Pro, you accept and agree to be bound by the terms and provision of this agreement.</p>
                </section>

                <section>
                    <h3 className="font-bold text-theme-text mb-2">2. Research Purposes Only</h3>
                    <p>All peptides sold on this website are for research purposes only. They are not intended for human consumption, medical use, or any therapeutic application. By purchasing from Peptide Pro, you acknowledge that you are a qualified researcher or institution.</p>
                </section>
                ...
                <section>
                    ...
                    <p>Peptide Pro shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use of or inability to use the service.</p>
                </section>
                ...
                <section>
                    ...
                    <p>If you have any questions about these Terms and Conditions, please contact us at peptidepropeftify@gmail.com</p>
                </section>
            </div>
                ...
                return (
                    <div className="space-y-6 animate-fadeIn">
                        <div className="text-center mb-8">
                            ...
                            <h2 className="text-2xl font-bold text-theme-text">Thank you for choosing Peptide Pro!</h2>
