  ...
  const handleResetDefaults = () => {
    if (confirm('Are you sure you want to reset the homepage content to defaults?')) {
      setFormData(prev => ({
        ...
        hero_description: 'Peptide Pro is your destination for high-quality peptide solutions rooted in modern science, transparency, and patient-focused innovation.',
      }));
    }
  };
